    ...
    ChildSlot
        [
            ...
            + SOverlay::Slot()
                ...
                [
					SNew(SVerticalBox)
					+ SVerticalBox::Slot().Padding(10.0f).FillHeight(3.f)
					[
						SNew(SHorizontalBox)
						+ SHorizontalBox::Slot().FillWidth(2.0f).Padding(10.0f)
						[
							SNew(STextBlock)
							.Text(FString("Volume: "))
						]
						+ SHorizontalBox::Slot().FillWidth(2.0f).Padding(5.0f, 0.0f, 5.0f, 0.0f)
						[
							SNew(SVolumeControl)
